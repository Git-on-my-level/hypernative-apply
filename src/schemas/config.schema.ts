import { z } from 'zod';
import { watchlistSchema, type WatchlistConfig } from './watchlist.schema.js';
import { customAgentSchema, type CustomAgentConfig } from './custom-agent.schema.js';
import { completeNotificationChannelSchema, type CompleteNotificationChannelConfig } from './notification-channel.schema.js';
...
const globalConfigSchema = z.object({
  ...
  integrations: z.object({
    ...
    external_services: z.record(z.object({
...
const resourceCollectionsSchema = z.object({
...
export const rootConfigSchema = z.object({
  ...
  (data) => {
    ...
    return (
      (resources.notification_channels && Object.keys(resources.notification_channels).length > 0) ||
...
export const crossReferenceValidationSchema = z.object({
  valid: z.boolean(),
  missing_references: z.array(z.object({
  ...
  circular_references: z.array(z.object({
...
// Resource type definitions for convenience
...
export function createEmptyParsedConfig(): ParsedConfig {
  return {
    global: undefined,
