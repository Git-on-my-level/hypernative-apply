...
export class CustomAgentProvider {
     ...
     */
    validateBalanceChangeConfig(config, errors, warnings) {
    ...
    validateHealthDeviationConfig(config, errors, _warnings) {
        const cfg = config.configuration || {};
        if (!cfg.protocol) {
    ...
    validateTransactionConfig(config, errors, _warnings) {
        const cfg = config.configuration || {};
    ...
    validateGovernanceConfig(config, errors, _warnings) {
        const cfg = config.configuration || {};
     ...
     */
    static hasTypeChanged(config, remoteAgent) {
 ...
 */
export function createCustomAgentProvider(apiClient, dryRun) {
    return new CustomAgentProvider({ apiClient, dryRun });
}
//# sourceMappingURL=custom-agent.provider.js.map