 ...
 */
function resolveProfileName(flags, envConfig, profileConfig) {
 ...
 */
function getProfileByName(profileName, profileConfig) {
...
export async function loadConfig(flags = {}) {
    try {
        ...
        if (!flags.baseUrl && (!resolvedConfig.clientId || !resolvedConfig.clientSecret)) {
            ...
            throw new Error(`Missing required configuration: ${missingFields.join(' and ')}. ` +
 ...
 */
export async function getConfigDebugInfo(flags = {}) {
    try {
        ...
        return {
            ...
            configSources: {
                ...
                environment: !!(envConfig.HN_CLIENT_ID ||
