 ...
 */
export async function writeSecureFile(filePath, content, encoding = 'utf-8') {
 ...
 */
export async function createSecureDirectory(dirPath, recursive = true) {
 ...
 */
export async function setSecureDirectoryPermissions(dirPath) {
 ...
 * @param encoding - Text encoding (default: 'utf-8')
 */
export async function writeFileWithSecurePermissions(filePath, content, encoding = 'utf-8') {
 ...
 * @param recursive - Create parent directories if needed (default: true)
 */
export async function createDirectoryWithSecurePermissions(dirPath, recursive = true) {
