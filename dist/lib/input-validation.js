...
export class InputValidator {
     ...
     * Validate file size
     */
    validateFileSize(fileSizeBytes, fieldName = 'file') {
    ...
    validateDescription(description) {
        return this.validateStringLength(description, 'description', this.limits.max_description_length);
    }
    /**
     ...
     */
    validateWatchlistAssets(assets) {
     ...
     */
    validateTotalResources(config) {
        const totalResources = Object.keys(config.notification_channels).length +
 ...
 */
export function createInputValidator(config) {
    return new InputValidator(config);
}
/**
 * Validate configuration and throw error if invalid
 */
export function validateConfigurationOrThrow(config) {
