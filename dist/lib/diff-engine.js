 ...
 */
export function deepCompare(oldObj, newObj, options = {}) {
    const opts = {
 ...
 */
function cleanForComparison(obj, options) {
 ...
 */
function isSensitiveField(fieldPath, customPatterns = []) {
 ...
 */
function compareObjects(oldObj, newObj, path, diffs, summary, options, depth) {
 ...
 */
function compareArrays(oldArr, newArr, path, diffs, summary, options, depth) {
 ...
 */
function addFieldDiff(diffs, summary, path, oldValue, newValue, changeType, options) {
 ...
 */
export function formatFieldDiffs(diffs, options = {}) {
